...
function Reservas({onReservaConfirmada}) {
  ...
  const imagenes = [
     require("../image/salon.png"),
     require("../image/slider.png"),
     require("../image/salon_1.png"),
     require("../image/slider_1.png"),
     require("../image/salon_2.png"),
     require("../image/slider_2.png"),
     require("../image/salon_3.png"),
     require("../image/slider_3.png"),
     require("../image/salon_4.png"),
     require("../image/slider_4.png"),
     require("../image/salon_5.png"),
     require("../image/slider_5.png"),
     require("../image/salon_6.png"),
     require("../image/slider_6.png"),
    ];
